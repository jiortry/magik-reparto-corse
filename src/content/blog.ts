...
export type PostFaq = { q: { it: string; en: string }; a: { it: string; en: string } };
...
export const posts: Post[] = [
  {
    ...
    sections: [
      ...
      {
        id: "motore",
        heading: { it: "2. Motore: check e carburazione", en: "2. Engine: checks and jetting" },
        paragraphs: {
          it: [
      ...
      {
        id: "gomme-freni",
        heading: { it: "3. Gomme e freni", en: "3. Tyres and brakes" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      {
        id: "ruoli",
        heading: { it: "I ruoli sotto la tenda", en: "Roles under the awning" },
        paragraphs: {
          it: [
      ...
      {
        id: "sessioni",
        heading: { it: "Come si usa ogni sessione", en: "How each session is used" },
        paragraphs: {
          it: [
      ...
      {
        id: "quando-serve",
        heading: { it: "Quando conviene l'assistenza", en: "When support is worth it" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "convergenza",
        heading: { it: "Convergenza (toe)", en: "Toe" },
        paragraphs: {
          it: [
      ...
      {
        id: "campanatura",
        heading: { it: "Campanatura (camber)", en: "Camber" },
        paragraphs: {
          it: [
      ...
      },
      {
        ...
        heading: { it: "Carreggiata e assale", en: "Track width and axle" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      {
        id: "manutenzione",
        heading: { it: "Intervalli di manutenzione", en: "Maintenance intervals" },
        paragraphs: {
          it: [
      ...
      {
        id: "supporto",
        heading: { it: "Cosa offriamo come rivenditore", en: "What we offer as a dealer" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      {
        id: "voci",
        heading: { it: "Le voci da mettere a budget", en: "The items to budget for" },
        paragraphs: {
          it: [
      ...
      {
        id: "risparmiare",
        heading: { it: "Dove si risparmia (e dove no)", en: "Where to save (and where not to)" },
        paragraphs: {
          it: [
      ...
      {
        id: "primo-anno",
        heading: { it: "Un primo anno realistico", en: "A realistic first year" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      {
        id: "mini",
        heading: { it: "Mini e 60cc: la base", en: "Mini and 60cc: the foundation" },
        paragraphs: {
          it: [
      ...
      {
        id: "monomarcia",
        heading: { it: "Monomarcia 125: X30, OK e OK-N", en: "125 single-speed: X30, OK, OK-N" },
        paragraphs: {
          it: [
      ...
      {
        id: "kz",
        heading: { it: "KZ: il cambio e il livello massimo", en: "KZ: gearbox and the top tier" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      {
        id: "progetto",
        heading: { it: "Il progetto", en: "The project" },
        paragraphs: {
          it: [
      ...
      {
        id: "metodo",
        heading: { it: "Il metodo", en: "The method" },
        paragraphs: {
          it: [
      ...
      {
        id: "obiettivo",
        heading: { it: "L'obiettivo", en: "The goal" },
        paragraphs: {
          it: [
  ...
  },
  {
    ...
    sections: [
      {
        id: "cinque",
        heading: { it: "I cinque punti", en: "The five points" },
        paragraphs: {
          it: [
      ...
      {
        id: "genitori",
        heading: { it: "Una nota per i genitori", en: "A note for parents" },
        paragraphs: {
          it: [
...
export function readingMinutes(post: Post, lang: "it" | "en"): number {
  const chunks = [
    post.intro[lang],
...
export function postPlainText(post: Post, lang: "it" | "en"): string {
  return [
    post.intro[lang],
    ...post.sections.flatMap((s) => [
      s.heading[lang],
...
export function relatedPosts(post: Post, lang: "it" | "en", limit = 3): Post[] {
