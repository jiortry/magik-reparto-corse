    ...
    <footer className="relative border-t border-border bg-carbon">
      ...
      <div className="mx-auto max-w-[1400px] px-5 lg:px-8 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/services" className="text-foreground/70 hover:text-primary">
                {t.nav.services}
              </Link>
            </li>
            <li>
              <Link to="/kart-magik" className="text-foreground/70 hover:text-primary">
                {t.nav.kart}
              </Link>
            </li>
            <li>
              <Link to="/team" className="text-foreground/70 hover:text-primary">
                {t.nav.team}
              </Link>
            </li>
            <li>
              <Link to="/gallery" className="text-foreground/70 hover:text-primary">
                {t.nav.gallery}
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/contact" className="text-foreground/70 hover:text-primary">
                {t.nav.contact}
              </Link>
            </li>
            <li>
              <Link to="/lke" className="text-foreground/70 hover:text-primary">
                LKE Emilia-Romagna
              </Link>
            </li>
            <li>
              <Link to="/faq" className="text-foreground/70 hover:text-primary">
                {t.nav.faq}
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-[1400px] px-5 lg:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <span>
            © {year} MAGIK Reparto Corse. {t.footer.rights}
          </span>
