import { k as compileDecodeCharMap, c as createLRUCache, t as trimPath, l as rewriteBasepath, m as composeRewrites, p as processRouteTree, n as processRouteMasks, o as resolvePath, q as cleanPath, s as trimPathRight, g as createControlledPromise, u as parseHref, v as executeRewriteInput, w as isDangerousProtocol, x as redirect, b as isRedirect, d as isNotFound, y as findSingleMatch, z as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, A as buildRouteBranch, B as interpolatePath, C as nullReplaceEqualDeep, E as replaceEqualDeep$1, F as last, G as decodePath, H as findFlatMatch, f as functionalUpdate$1, I as findRouteMatch, i as isPromise, e as invariant$1, h as rootRouteId, O as useRouter, V as jsxRuntimeExports, a0 as Outlet, J as hasKeys, K as executeRewriteOutput, a as arraysEqual, r as reactExports, a1 as notFound, U as React, S as exactPathTest, T as removeTrailingSlash, W as isModuleNotFoundError, j as isServer, P as dummyMatchContext, Q as matchContext, Y as escapeHtml, Z as isInlinableStylesheet, _ as getAssetCrossOrigin, X as useHydrated, M as trimPathLeft, N as joinPaths, $ as resolveManifestAssetLink, L as encodePathLikeUrl, R as requireReactDom } from "./server-DVrhaJxa.mjs";
...
const appCss = "/assets/styles-DFmd6TkX.css";
const dictionary = {
  it: {
    nav: {
      home: "Home",
    ...
    hero: {
      ...
      lead: "Prepariamo, assistiamo e portiamo in pista il Kart Magik con un solo obiettivo: vincere.",
      scroll: "Scroll"
    },
    home: {
      missionEyebrow: "La Missione",
      missionTitle: "Vincere i Mondiali con il Kart Magik.",
      missionLead: "Un reparto corse costruito attorno a una sola promessa: portare il marchio Magik sul gradino più alto del podio internazionale.",
    ...
    team: {
      title: "Racing Team",
      eyebrow: "Il Team",
      lead: "Un team tecnico, veloce e determinato. Dalla preparazione del kart all'assistenza in pista, ogni dettaglio è studiato per vincere."
    },
    gallery: {
      title: "Gallery",
      eyebrow: "In Pista",
  ...
  en: {
    ...
    hero: {
      ...
      lead: "We prepare, support and race the Magik Kart with one single goal: to win.",
      scroll: "Scroll"
    },
    home: {
      missionEyebrow: "Our Mission",
      missionTitle: "Win the World Championship with the Magik Kart.",
      missionLead: "A racing department built around one promise: to bring the Magik brand to the top step of the international podium.",
    ...
    team: {
      title: "Racing Team",
      eyebrow: "The Team",
      lead: "A technical, fast and determined team. From kart preparation to trackside support, every detail is engineered to win."
    },
    gallery: {
      title: "Gallery",
      eyebrow: "On Track",
...
function LanguageProvider({ children }) {
  const [lang, setLangState] = reactExports.useState("it");
  const [hasChosen, setHasChosen] = reactExports.useState(false);
  ...
  const changeLangAnimated = reactExports.useCallback(
    (l) => {
      if (l === lang) return;
...
const logo = "/assets/logo-magik-0C4jFJDx.png";
function LanguageSwitcher() {
  const { lang, changeLangAnimated } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center rounded-full border border-border bg-card/60 p-0.5 text-[11px] font-display font-bold uppercase tracking-widest", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => changeLangAnimated("it"),
        className: `relative z-10 px-3 py-1 rounded-full transition-colors ${lang === "it" ? "text-primary-foreground" : "text-foreground/60 hover:text-foreground"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: `relative z-10 px-3 py-1 rounded-full transition-colors ${lang === "en" ? "text-primary-foreground" : "text-foreground/60 hover:text-foreground"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: `absolute top-0.5 bottom-0.5 w-[calc(50%-2px)] rounded-full bg-primary transition-transform duration-300 ${lang === "en" ? "translate-x-[calc(100%+0px)]" : "translate-x-0"}`,
        style: { left: "2px" }
      }
    )
  ] });
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? "bg-carbon/90 backdrop-blur-xl border-b border-border" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-[1400px] items-center justify-between px-5 py-3 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-2 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "MAGIK Reparto Corse", className: "h-8 lg:h-10 w-auto" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden xl:flex items-center gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: l.to,
              ...
              children: [
                l.label,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 right-3 -bottom-0.5 h-px origin-left scale-x-0 bg-primary transition-transform duration-300 group-hover:scale-x-100" })
              ]
            },
            l.to
          )) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.nav,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1400px] px-5 py-4 flex flex-col gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: l.to,
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative border-t border-border bg-carbon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 top-0 h-px racing-stripe" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-5 lg:px-8 py-14 grid gap-10 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "MAGIK Reparto Corse", className: "h-10 w-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-md text-sm text-muted-foreground leading-relaxed", children: t.footer.desc }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-display uppercase tracking-widest text-accent mb-4", children: t.footer.quickLinks }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "text-foreground/70 hover:text-primary", children: t.nav.about }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "text-foreground/70 hover:text-primary", children: t.nav.services }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/kart-magik", className: "text-foreground/70 hover:text-primary", children: t.nav.kart }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/team", className: "text-foreground/70 hover:text-primary", children: t.nav.team }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/gallery", className: "text-foreground/70 hover:text-primary", children: t.nav.gallery }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-display uppercase tracking-widest text-accent mb-4", children: t.footer.contact }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "text-foreground/70 hover:text-primary", children: t.nav.contact }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/lke", className: "text-foreground/70 hover:text-primary", children: "LKE Emilia-Romagna" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/faq", className: "text-foreground/70 hover:text-primary", children: t.nav.faq }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", className: "text-foreground/70 hover:text-primary", children: t.nav.blog }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-5 lg:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display uppercase tracking-widest text-accent/80", children: "Performance · Tecnica · Ambizione" })
    ] }) })
  ] });
}
function LanguagePopup() {
  const { hasChosen, setLang, t } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !hasChosen && /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 top-0 h-px racing-stripe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-px bg-accent/40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-8 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "MAGIK Reparto Corse", className: "mx-auto h-12 w-auto mb-6" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-accent font-display font-bold", children: t.common.langPickTitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs uppercase tracking-[0.3em] text-foreground/40 font-display", children: t.common.langPickSub }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      "Italiano",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-x-0 bottom-0 h-0.5 bg-primary scale-x-0 group-hover:scale-x-100 origin-left transition-transform" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
const gokart = "/assets/gokart-CsG3Tuxe.png";
function KartTransition() {
  const { isTransitioning } = useLang();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isTransitioning && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-radial from-carbon/40 via-carbon/90 to-carbon" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0", children: Array.from({ length: 18 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function IntroLoader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: show && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-overlay opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { scaleX: 0 },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline font-display text-xs font-bold uppercase tracking-widest", children: "WhatsApp" })
      ]
    }
  );
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-carbon px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xs uppercase tracking-[0.4em] text-accent", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 font-display font-black uppercase italic text-6xl text-foreground", children: "Off Track" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "La pagina che cerchi non esiste." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
...
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-carbon px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-black uppercase italic text-3xl text-foreground", children: "Something broke" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "border border-border px-4 py-2 text-xs font-display uppercase tracking-widest", children: "Home" })
    ] })
  ] }) });
}
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Reparto corse ufficiale del marchio Magik. Preparazione, assistenza in pista, ricambi kart e rivenditore LKE in Emilia-Romagna.",
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "it", suppressHydrationWarning: true, children: [
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LanguageProvider, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IntroLoader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(LanguagePopup, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(KartTransition, {}),
...
const $$splitComponentImporter$a = () => import("./team-g7L3oQ1U.mjs");
const Route$a = createFileRoute("/team")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Un team tecnico, veloce e determinato: dalla preparazione del kart all'assistenza in pista."
    }, {
      property: "og:title",
      content: "Racing Team — MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "Ogni dettaglio è studiato per vincere."
    }, {
      property: "og:url",
      content: "/team"
    }],
...
const $$splitComponentImporter$9 = () => import("./services-CHXJPz-K.mjs");
const Route$9 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Riparazione go-kart, assistenza tecnica e in pista, vendita ricambi kart, giornata di pista e rivenditore LKE Emilia-Romagna."
    }, {
      property: "og:title",
      content: "Servizi MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "Dalla preparazione tecnica alla pista: ogni fase della performance."
    }, {
      property: "og:url",
      content: "/services"
    }],
...
const $$splitComponentImporter$8 = () => import("./lke-DJKz8DP1.mjs");
const Route$8 = createFileRoute("/lke")({
  head: () => ({
    meta: [{
      title: "Motore LKE Emilia-Romagna — Rivenditore Ufficiale | MAGIK"
    }, {
      name: "description",
      content: "MAGIK è rivenditore ufficiale del motore LKE in Emilia-Romagna: supporto tecnico, ricambi e consulenza."
    }, {
      property: "og:title",
      content: "LKE Emilia-Romagna — Rivenditore Ufficiale"
    }, {
      property: "og:description",
      content: "Supporto tecnico, disponibilità ricambi e consulenza specializzata sul motore LKE."
    }, {
      property: "og:url",
      content: "/lke"
    }],
...
const $$splitComponentImporter$7 = () => import("./kart-magik-C2mfZqUv.mjs");
const Route$7 = createFileRoute("/kart-magik")({
  head: () => ({
    meta: [{
      title: "Kart Magik Omologato — Telaio, Motore, Setup | MAGIK Reparto Corse"
    }, {
      name: "description",
      content: "Il Kart Magik omologato: telaio racing, impianto frenante, radiatore, motore LKE e setup gara curato dal team."
    }, {
      property: "og:title",
      content: "Kart Magik Omologato"
    }, {
      property: "og:description",
      content: "Un telaio sviluppato per la velocità, la precisione e l'affidabilità in gara."
    }, {
      property: "og:url",
      content: "/kart-magik"
    }],
...
const $$splitComponentImporter$6 = () => import("./gallery-CDfChB2x.mjs");
const Route$6 = createFileRoute("/gallery")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Immagini dal box, dalla pista e dai momenti che contano del MAGIK Reparto Corse."
    }, {
      property: "og:title",
      content: "Gallery — MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "In pista, in box, dietro le quinte."
    }, {
      property: "og:url",
      content: "/gallery"
    }],
...
const faqItems = {
  it: [
    { q: "Che cos'è MAGIK Reparto Corse?", a: "È il reparto corse ufficiale del marchio Magik: prepariamo, sviluppiamo e portiamo in pista il Kart Magik, con un team tecnico professionale." },
    { q: "Offrite assistenza in pista?", a: "Sì. Affianchiamo piloti e team durante prove e gare con supporto tecnico, setup, manutenzione e gestione meccanica completa." },
    { q: "Posso acquistare ricambi da voi?", a: "Sì, siamo punto vendita per ricambi kart all'ingrosso e al dettaglio, con consulenza tecnica specializzata." },
    { q: "Siete rivenditori LKE?", a: "Sì, siamo rivenditori ufficiali LKE in Emilia-Romagna, con supporto tecnico, ricambi disponibili e assistenza diretta." },
  ...
  en: [
    ...
    { q: "Do you offer trackside support?", a: "Yes. We support drivers and teams during practice and races with technical assistance, setup, maintenance and full mechanical management." },
    { q: "Can I buy spare parts from you?", a: "Yes, we are a kart parts retailer (wholesale and retail) with specialised technical consulting." },
    { q: "Are you LKE dealers?", a: "Yes, we are official LKE dealers in Emilia-Romagna, with technical support, parts in stock and direct assistance." },
...
const $$splitComponentImporter$5 = () => import("./faq-B36UerOr.mjs");
const Route$5 = createFileRoute("/faq")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Risposte sulle nostre attività: assistenza in pista, ricambi kart, motore LKE, riparazione go-kart e team racing."
    }, {
      property: "og:title",
      content: "FAQ — MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "Le risposte più richieste."
    }, {
      property: "og:url",
      content: "/faq"
    }],
...
const $$splitComponentImporter$4 = () => import("./contact-CmHryNq9.mjs");
const Route$4 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Contatta MAGIK Reparto Corse: assistenza tecnica kart, ricambi, motore LKE, giornate di pista e gare."
    }, {
      property: "og:title",
      content: "Contatti — MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "Parla con il team."
    }, {
      property: "og:url",
      content: "/contact"
    }],
...
const $$splitComponentImporter$3 = () => import("./blog-B3dEB7kP.mjs");
const Route$3 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "News, tecnica, setup, motori LKE e dietro le quinte di MAGIK Reparto Corse."
    }, {
      property: "og:title",
      content: "Blog — MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "Insights racing, setup e dietro le quinte."
    }, {
      property: "og:url",
      content: "/blog"
    }],
...
const $$splitComponentImporter$2 = () => import("./about-CpyiOUN8.mjs");
const Route$2 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "MAGIK Reparto Corse: il reparto corse ufficiale del Kart Magik. Tecnica, metodo, ambizione mondiale."
    }, {
      property: "og:title",
      content: "Chi Siamo — MAGIK Reparto Corse"
    }, {
      property: "og:description",
      content: "Nati per portare il Kart Magik al massimo livello competitivo."
    }, {
      property: "og:url",
      content: "/about"
    }],
...
const $$splitComponentImporter$1 = () => import("./index-17_2uRPP.mjs");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Reparto corse ufficiale del Kart Magik. Assistenza in pista, riparazione go-kart, ricambi e rivenditore LKE in Emilia-Romagna."
    }, {
      property: "og:title",
      content: "MAGIK Reparto Corse — Performance, tecnica e ambizione mondiale"
    }, {
      property: "og:description",
      content: "Prepariamo, assistiamo e portiamo in pista il Kart Magik con un solo obiettivo: vincere."
    }, {
      property: "og:url",
      content: "/"
    }],
...
const kartTrack = "/assets/kart-track-DyS_JVKd.jpg";
const kartCorner = "/assets/kart-corner-DKiI14Uu.jpg";
const kartPit = "/assets/kart-pitlane-B2AwGGFG.jpg";
const pilot = "/assets/pilot-helmet-AjF2GnYt.jpg";
const kartStudio = "/assets/kart-studio-1l6s8p3T.jpg";
...
const $$splitNotFoundComponentImporter = () => import("./blog._slug-C7J1qLYL.mjs");
const $$splitComponentImporter = () => import("./blog._slug-H9RhFLW1.mjs");
const Route2 = createFileRoute("/blog/$slug")({
  ...
  head: ({
    ...
    if (!p) return {
      meta: [{
        title: "Post — MAGIK Reparto Corse"
      }]
    };
    return {
      meta: [{
...
const LkeRoute = Route$8.update({
  id: "/lke",
  path: "/lke",
  getParentRoute: () => Route$b
});
const KartMagikRoute = Route$7.update({
  id: "/kart-magik",
  path: "/kart-magik",
  getParentRoute: () => Route$b
});
