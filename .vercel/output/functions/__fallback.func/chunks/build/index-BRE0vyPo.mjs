...
import { u as useLang, m as motion, g as gokart } from "./router-FaIjrp16.mjs";
import { R as RacingButton } from "./RacingButton-DHpVggpD.mjs";
import { S as ServiceCard, u as useMotionValue, a as useSpring, b as useTransform } from "./ServiceCard-qRHD2yb2.mjs";
import { S as SectionHeader } from "./SectionHeader-Dv5izfbj.mjs";
import { m as missionPhoto } from "./D4S_2474-CNNFI6oT.mjs";
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-5 lg:px-8 grid gap-12 lg:grid-cols-2 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { initial: {
            ...
            duration: 0.7
          }, src: missionPhoto, alt: "Kart Magik in pista — MAGIK Reparto Corse", className: "relative clip-diagonal w-full aspect-[4/5] object-cover" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-20 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-5 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black uppercase italic text-3xl md:text-5xl tracking-tight", children: t.home.ctaClosing }),
